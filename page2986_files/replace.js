...
function startCdnPlayer (fileId, videoHash) {
    new Clappr.Player({
      ...
      //source: "//getcourse.cdnvideo.ru/getcourse-vod/_definst_/mp4:fileservice/file/download-proxy/h/" + videoHash + "/playlist.m3u8",
        source: "https://vh-41.getcourse.ru:8082/vod_hls/fileservice/file/download-proxy/h/" + videoHash + "/master.m3u8",
        autoPlay: false,
      width: '100%',
      height: '100%',
      playback: {
